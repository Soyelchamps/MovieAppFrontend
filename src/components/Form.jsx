...
const Form = () => {
  ...
  const noteId =
    location.state && location.state.id !== undefined ? location.state.id : "";
  const titleNote =
    location.state && location.state.title !== undefined
      ? location.state.title
      : "";
  const contentNote =
    location.state && location.state.content !== undefined
      ? location.state.content
      : "";
  const dateNote =
    location.state && location.state.date !== undefined
      ? location.state.date
      : "";
  const authorNote =
    location.state && location.state.author !== undefined
  ...
  return (
    <form
      onSubmit={async (e) => {
        ...
        if (getStateObj) {
          await updateNote({
            variables: { title, content, date, author, id },
          });
        } else {
          await createNote({
